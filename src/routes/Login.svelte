<script>
    import { loginSubmit } from "../services/Login/LoginService";
</script>

<main>
    <div class='login-main-container'>
        <form class='login-form' on:submit={loginSubmit}>
            ...
            <div class='login-data-container'>
                <div>
                    ...
                    <input type='email' name='email' placeholder='youremail@company.com' class='login-input'/>
